...
Четыре сеттинга — четыре разных стиля игры. Выбирай серию, чтобы увидеть персонажей.
...
<a href="#/bots/forest/" class="series-card" style="background-image: url('assets/covers/forest.jpg')">
  <span class="card-subtitle">Аномальная зона, хардкорный выживач</span>
