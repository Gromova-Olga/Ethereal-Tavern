...
Всё просто: копируете нужный блок и вставляете его в `System Prompt` (или в `Author's Note` / кастомный промпт для конкретной ситуации). 

Это модульная система. **Не пытайтесь включить всё сразу.** Если вы одновременно заставите модель бросать кубики, как в Disco Elysium, писать комментарии с галёрки и выдавать медицинский статус — она просто сойдёт с ума, подавится контекстом и выдаст вам нечитаемую кашу. Включайте блоки точечно, под конкретную сцену или сеттинг.
...
Превращает ваши решения во внутренний диалог с собственными навыками, которые спорят друг с другом. Очень атмосферная штука.
...
Отличный инструмент для боевок и саспенса. Заставляет бота учитывать психологическое давление на персонажа.
...
Мрачный и клинический блок для дарк-фэнтези, киберпанка или постапока. Требует от персонажа конкретных действий для выживания.
